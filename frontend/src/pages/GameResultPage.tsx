...
const GameResultPage = ({ gameData }) => {
  ...
  const accuracy =
    totalShots > 0 ? Number(((hits / totalShots) * 100).toFixed(2)) : 0;
  ...
  useEffect(() => {
    ...
    const audio = gameData.winner
      ? new Audio(winnerMusic)
      : new Audio(loserMusic);
    ...
    <div className="max-w-xl mx-auto p-4 bg-white shadow-md rounded-lg">
      ...
      <div className="stats-section mt-6">
        ...
        <ul className="list-disc pl-6 mb-6">
          ...
          <li>
            Total de Piezas Hundidas del Oponente: {hits} / {totalPieces}
          </li>
